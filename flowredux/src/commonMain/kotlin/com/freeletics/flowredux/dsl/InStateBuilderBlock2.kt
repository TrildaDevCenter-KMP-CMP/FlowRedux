...
@FlowReduxDsl
public class InStateBuilderBlock2<InputState : S, S : Any, A : Any> internal constructor(
    ...
    public fun condition(
        ...
        block: ConditionBuilderBlock2<InputState, S, A>.() -> Unit,
    ) {
        sideEffectBuilders += ConditionBuilderBlock2<InputState, S, A> {
